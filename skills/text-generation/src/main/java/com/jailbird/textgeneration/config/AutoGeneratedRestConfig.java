...
public class AutoGeneratedRestConfig {
     ...
     * - POST /api/v1/text-generation/generate (google.api.http annotation)
     * - POST /api/v1/text-generation/generate-stream (google.api.http annotation)  
     * - GET /api/v1/text-generation/health (google.api.http annotation)
     * 
